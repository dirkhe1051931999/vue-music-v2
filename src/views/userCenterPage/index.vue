<template>
  <div ref="container" class="container">
    <!--导航栏-->
    <TitleBar ref="titleBar" @openSearch="$router.push('/search')" style="height: 9.6vw" :active="1" />
    <!-- tab切换 -->
    <div class="navigate">
      <div :class="{ active: currentNavIndex === index }" v-for="(item, index) in navigate" :key="index" @click="currentNavIndex = index">
        {{ item }}
      </div>
    </div>
    <!-- 播放列表 -->
